        ...
        <div className="p-4 flex items-center w-full h-full flex-col">
            ...
            <div className="flex flex-col items-center w-full">
              <div className='w-full flex items-center justify-center'>
                <img className="w-10 h-10 rounded-full mb-2 mr-4" src="https://dummyimage.com/40x40/ddd/000.jpg" alt="Avatar of Jonathan Reinink" />
                <TextField
                  id="textarea"
                  type="text"
                  ...
                  multiple={true}
                />
                <img className="w-10 h-10 rounded-full mb-2 ml-4" src="https://dummyimage.com/40x40/ddd/000.jpg" alt="Avatar of Jonathan Reinink" />
              </div>
