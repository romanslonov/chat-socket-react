<template>
  <div class="flex flex-col border-r shadow" style="width:320px">
    <!-- <div class="flex items-center p-4">
      <input
        class="bg-gray-200 rounded-full w-full py-1 px-2 mr-2"
        type="text"
        placeholder="Search"
      />
      <button>
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          16.9706 7.02944 21 12 21ZM17 11H13V7H11V11H7V13H11V17H13V13H17V11Z" fill="black"/>
        </svg>
      </button>
    </div> -->
    ...
    <div v-if="user" class="border-t p-2">
      <button class="
          flex
          items-center
          text-left
